...
class DraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post drafts_url, params: { draft: { approval_status_id: @draft.approval_status_id, category_id: @draft.category_id, content: @draft.content, title: @draft.title } }
    end
  ...
  test "should update draft" do
    patch draft_url(@draft), params: { draft: { approval_status_id: @draft.approval_status_id, category_id: @draft.category_id, content: @draft.content, title: @draft.title } }
